...
trainer = Trainer(
    ...
    compute_metrics=None,  # Add your custom metric function here if needed
)
...
for epoch in range(training_args.num_train_epochs):
    for step, batch in enumerate(trainer.get_train_dataloader()):
        ...
        # Add any additional logging or metric tracking here
    ...
    for batch in trainer.get_eval_dataloader():
        with torch.no_grad():
            ...
            # Add validation metrics and logging here
